...
const FileUpload = ({ label, icon, onChange, name, className = '' }) => (
    <div className={className}>
        ...
        <div className="relative">
            ...
            />
            <div className="w-full px-4 py-3 bg-slate-50/50 border border-[#6366F1]/20 rounded-2xl text-slate-800 flex items-center justify-center gap-2 cursor-pointer hover:bg-white/80 transition-all duration-200">
...
const EmployeeTargetCard = ({ employee, targetValue, onTargetChange, isSelected, onClick }) => (
    ...
    >
        ...
        <div className="mt-3">
            <label className="text-xs text-slate-600 block mb-1">Target (Qty)</label>
            <input
                type="number"
                value={targetValue || 0}
                onChange={(e) => onTargetChange(employee.id, e.target.value)}
                min="0"
                className="w-full px-3 py-2 bg-white/80 border border-[#6366F1]/20 rounded-xl text-center focus:outline-none focus:ring-2 focus:ring-[#6366F1]/30 text-black"
        ...
        <div className="p-6 min-h-screen bg-gradient-to-br from-[#f8fafc] to-[#eef2f6] rounded-xl">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-8 gap-4">
                <div>
                    ...
                    <p className="text-slate-600 text-sm mt-2">Tetapkan target untuk employee dengan detail lengkap</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <GlassCard className="lg:col-span-1 p-5">
                    <h3 className="text-lg font-semibold text-slate-800 mb-4">Detail Target</h3>
                ...
                <GlassCard className="lg:col-span-2 p-5">
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="text-lg font-semibold text-slate-800">Daftar Employee</h3>
