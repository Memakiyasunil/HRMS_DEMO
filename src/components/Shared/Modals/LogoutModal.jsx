            ...
            >
                <div className="bg-slate-800/90 backdrop-blur-xl rounded-3xl p-6 shadow-2xl border border-slate-700/50">
                    <div className="flex flex-col items-center">
                        ...
                        <h3 className="mt-4 text-lg font-semibold text-slate-100">Confirm Logout</h3>
                    ...
                    <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                        <button
                            type="button"
                            className="w-full inline-flex justify-center items-center rounded-2xl border border-transparent bg-red-600 px-6 py-3 text-base font-semibold text-white shadow-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-slate-800 transition-all duration-200 transform hover:scale-[1.02]"
                            onClick={onConfirm}
                        >
                        ...
                        <button
                            type="button"
                            className="mt-3 sm:mt-0 w-full inline-flex justify-center items-center rounded-2xl bg-slate-700/60 backdrop-blur-sm px-6 py-3 text-base font-semibold text-slate-200 shadow-md border border-slate-600/50 hover:bg-slate-600/60 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 focus:ring-offset-slate-800 transition-all duration-200 transform hover:scale-[1.02]"
                            onClick={onClose}
                        >
                            <svg className="mr-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
