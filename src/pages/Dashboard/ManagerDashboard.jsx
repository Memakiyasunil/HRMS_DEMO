...
import ManagerPerformance from '../../components/Absensi/ManagerPerformance.jsx';
...
import ManagerSalary from '../../components/Absensi/ManagerSalary.jsx';
          ...
          >
            <div className="bg-white/90 backdrop-blur-2xl rounded-3xl shadow-sm border border-slate-200/60 p-4 md:sticky md:top-24 lg:sticky lg:top-24 h-full lg:h-auto overflow-y-auto">
              ...
              <div className="flex items-center mb-6 p-3 bg-slate-50/80 rounded-2xl border border-slate-200/60 shadow-sm text-left">
                ...
                <div className="ml-3">
                  <p className="text-sm font-semibold text-slate-700 truncate max-w-[120px]">{user?.name || 'Manager'}</p>
                  <p className="text-xs text-slate-500 capitalize">Manager</p>
                </div>
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-slate-200/60">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-center">
                  ...
                  <div className="bg-blue-50 rounded-2xl p-2 border border-slate-200/60 shadow-sm">
                    <i className="fas fa-plane text-blue-500 text-sm"></i>
                    <p className="text-xs text-slate-600 mt-1">Leave: {pendingLeave?.length || 0}</p>
                  </div>
                  <div className="bg-amber-50 rounded-2xl p-2 border border-slate-200/60 shadow-sm">
                    ...
                    <p className="text-xs text-slate-600 mt-1">Permission: {pendingPermissionCount}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-3">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1 text-left">
                    ...
                    {activeTab === 'performance' && 'Track your personal performance and task completion'}
